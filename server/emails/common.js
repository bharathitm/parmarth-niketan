export var confirmationTextBody = "All rooms have at least 2 beds (some have 3 or 4), with fans, coolers or AC and attached bathrooms \
with Western or Indian style toilets and hot water for bath. &#8377;400-500 per bed per night; or &#8377;800-1000 per night \
per room with 2 beds. Rates are dependent on room type. Please discuss your preferences with guest services at check-in.\
<br/><br/> \
...
<ul>\
<li> \
<b>As a general rule, you can check-in anytime between 9 am – 8 pm and check-out before 10 am</b>. \
</li> \
<li>\
Depending upon the operational and logistical needs of the ashram, early check-in and late check-out may be possible. \
We humbly invite you to discuss your particular needs with the Reception office by email or telephone \
before your arrival once your reservation is confirmed. If you're arriving early and check-in is not possible, \
we invite you to enjoy our gardens and facilities and to take advantage of any of the programs that may be taking place, \
such as drop-in yoga classes, until check-in is available. If you require a late departure, we invite you \
to check your luggage with Reception office and continue to enjoy the ashram and its facilities and programs \
until it's time for you to leave. \
</li>\
<li> \
If you need to contact the Ashram while en route, please call us at 0135-2434301, 0135-2434302, 7830060088. After arrival, \
please go to the reception office to check-in. \
</li> \
<li> \
Parking is available in the lot behind the ashram. For directions visit: https://www.parmarth.org/ashram/directions/ \
</li> \
<li> \
<b>Our housekeeping office is open from 9 am to 5 pm. If you need any housekeeping supplies [bed linen, towels, toilet paper soap] \
...
<li> \
Ashram guidelines are available at http://www.parmarth.org/ashram/guidelines/. It is expected that all visitors will respect \
and honor the Ashram guidelines. \
</li> \
<li> \
...
<li><b>Indian Nationals / residents: Guests of Indian nationality should bring your original photo ID with address and \
completed declaration form printed out [attached]. This is MANDATORY.</b></li> \
<li><b>Foreigners:</b> Guests of non-Indian nationality are required to email a photo or scanned copy of their passport ID \
and valid visa to India along with the completed C-form [attached] to reservations@parmarth.com at least 7 days \
prior to your arrival. You may complete the C-Form maintaining it on <b>one page</b> and email it back to us.</li></ul> \
</li> \
<li> \
As per the guidelines issued by External Affairs Ministry, Government of India Satellite phones are <b>completely banned</b> in India. \
...
We accept Visa and MasterCard. <br/><br/> \
<b>All funds received are donations to Swami Shukdevand Trust which manages the Ashram and its humanitarian services. \
We will not be able to refund any donations. \
